...
# =========================================================
    ...
    def run_single_question(question, model):
        ...
        return {
            ...
            "model": model,
            "answer": answer,
            "correct": score_answer(question["id"], answer),
            "latency_seconds": round(latency, 3),
            "top1_similarity": round(top_similarity, 4),
            "retrieved_documents": docs,
            "grounding": grounding_status(response)
        }
    ...
    for model_name in EVAL_MODELS:
        ...
        hallucinations = sum(
            1 for x in results
            if x["grounding"] == "Potential hallucination"
        )
        ...
        comparison.append({
            ...
            "Potential Hallucinations": str(hallucinations)
        })
